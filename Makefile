...
build:
	...
	ld -m elf_i386 -T kernel_linker.ld main.o vga.o gdt.o gdt_flush.o idt.o idt_flush.o isr.o isr_handler.o pic.o irq.o irq_handler.o -o kernel.elf -nostdlib
...
run: all
	qemu-system-i386 -m 64M -vga std -drive format=raw,file=test.bin 
